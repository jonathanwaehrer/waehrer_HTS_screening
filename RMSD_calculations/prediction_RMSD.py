...
def main():
    ...
    parser.add_argument("--proteins", required=True, help="Path to .pdb files for docking. Ligands (if present) will be removed.")
    parser.add_argument("--bin", required=True, help="Path to required binary executables.")
    parser.add_argument("--os", default='mac', help="Affects choice of binary executables. Choose between mac (default) or linux.")
